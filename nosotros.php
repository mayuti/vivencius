...
<body> <!-- Apertura de etiqueta del cuerpo de la web para despliege de contenido a visualizar -->
    <header>
        <h1>Sobre Vivencius</h1> <!-- Se coloca título principal -->
    </header>
    <main>
        <?php
            // Utiliza include para cargar el contenido de document_nosotros.html
            include('document/document_nosotros.html');
        ?>
    </main>

    <footer>
        <p class="com_fecha">Fecha: <?php echo date("d-m-Y"); ?></p> <!-- Se coloca la fecha -->
    </footer>
