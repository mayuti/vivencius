...
Custom user profiles plugin ❤ with paid memberships, groups, communities, content restriction, user registration, messaging, WooCommerce memberships, and a lot more!
...
[Free bbPress Integration](https://profilegrid.co/extensions/bbpress-integration/https://profilegrid.co/extensions/bbpress-integration/)
...
[User Photos](https://profilegrid.co/extensions/profilegrid-user-photos/)
...
[Menu Restrictions](https://profilegrid.co/extensions/profilegrid-menu-restrictions/)
...
[WooCommerce Wishlist Integration](https://profilegrid.co/extensions/woocommerce-wishlist/)
...
[Instagram Integration](https://profilegrid.co/extensions/instagram-integration/)
...
[Group Wall](https://profilegrid.co/extensions/group-wall/)

= Free Login Logout Menu =
...
[Login Logout Menu](https://profilegrid.co/extensions/profilegrid-login-logout-menu/)
...
[WooCommerce Extensions Integration](https://profilegrid.co/extensions/advanced-woocommerce-integration/)

= Free EventPrime Integration =

Create social events by integrating with [EventPrime, a WordPress events plugin](https://wordpress.org/plugins/eventprime-event-calendar-management/). Use the power of EventPrime's amazing event management tools to create and manage your very own ProfileGrid group and member events.

[EventPrime Integration](https://profilegrid.co/extensions/eventprime-integration/)
...
[Advanced Group Manager](https://profilegrid.co/extensions/frontend-group-manager/)
...
[Multiple Group Managers](https://profilegrid.co/extensions/multi-group-managers/)
...
[User Profile Labels](https://profilegrid.co/extensions/profilegrid-profile-labels/)
...
[Stripe Payments](https://profilegrid.co/extensions/stripe-payment-system/)
...
[User Profile Status](https://profilegrid.co/extensions/profilegrid-user-profile-status/)
...
[Hero Banner](https://profilegrid.co/extensions/profilegrid-hero-banner/)
...
[WooCommerce Subscription Integration](https://profilegrid.co/extensions/profilegrid-woocommerce-subscription-integration/)
...
[WooCommerce Members Discount](https://profilegrid.co/extensions/profilegrid-woocommerce-product-members-discount/)
...
[WooCommerce Product Tabs](https://profilegrid.co/extensions/profilegrid-woocommerce-product-custom-tabs/)

= Online Users =

Display a list of currently logged in users with their profile images and display names using WordPress widget.

[Online Users](https://profilegrid.co/extensions/profilegrid-users-online-widget/)
...
[User Activities](https://profilegrid.co/extensions/profilegrid-user-activities/)

= WooCommerce Product Recommendations =

Display product suggestions right inside user profiles based on the user's purchase history.

[WooCommerce Product Recommendations](https://profilegrid.co/extensions/profilegrid-woocommerce-product-recommendations/)

= Free Recent User Signups =
...
[Recent User Signups](https://profilegrid.co/extensions/profilegrid-recent-signup/)
...
[User Profile Reviews](https://profilegrid.co/extensions/profilegrid-member-profile-reviews/)

= Free User Groups Slider =
...
[User Group Slider](https://profilegrid.co/extensions/profilegrid-groups-carousel-widget/)
...
[User Slider](https://profilegrid.co/extensions/profilegrid-users-carousel-widget/)

= Free Featured Group =

A customizable banner widget that allows you to display a specified user group as featured group on your website.

[Featured Group](https://profilegrid.co/extensions/profilegrid-featured-group/)
...
[Profile Completeness](https://profilegrid.co/extensions/profilegrid-profile-completeness/)
...
[Widgets Privacy](https://profilegrid.co/extensions/profilegrid-widgets-privacy/)
...
[Zapier Integration](https://profilegrid.co/extensions/profilegrid-zapier-integration/)

= Free MailPoet Integration =
...
[MailPoet Integration](https://profilegrid.co/extensions/profilegrid-mailpoet/)

= Free Elementor Content Restrictions =
...
[Elementor Content Restrictions](https://profilegrid.co/extensions/profilegrid-elementor-content-restrictions/)
...
[Elementor User Login](https://profilegrid.co/extensions/profilegrid-elementor-user-login/)

= Free Elementor Integration - Elementor User Profiles Plugin =

Use ProfileGrid elements as native Elementor widgets and build custom layouts you always wanted with your favorite composer.

[Elementor Integration](https://profilegrid.co/extensions/profilegrid-elementor-integration/)


= Customized Group Slugs =

Use ProfileGrid to customize Group slugs and update SEO page title and description.

[Customized Group Slugs](https://profilegrid.co/extensions/profilegrid-customized-group-slugs/)

= WooCommerce Customized Product Restrictions =

Adds control over WooCommerce products visibility to ProfileGrid Groups.

[WooCommerce Customized Product Restrictions](https://profilegrid.co/extensions/profilegrid-wooCommerce-customized-product-restrictions/)
...
7. User can change profile image or user avatar and cover photo easily.
