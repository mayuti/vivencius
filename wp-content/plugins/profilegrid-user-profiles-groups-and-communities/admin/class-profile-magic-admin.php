...
class Profile_Magic_Admin {
	...
	public function pg_activation_redirect() {
		...
		if ( $dbhandler->get_global_option_value( 'pg_redirect_to_group_page', '0' ) == '1' ) {
							wp_safe_redirect( 'admin.php?page=pm_manage_groups' );
			exit;
		}
	}
        ...
        <div class="pg-box-col-4 pg-card-mb-16 pg-ext-card ">
            <div class="pg-box-border pg-box-p-18 pg-box-white-bg pg-box-h-100">
                <div class="pg-box-row pg-box-h-100">
                    ...
                    <div class="pg-ext-box-icon"> <img src="<?php echo $path; ?>partials/images/pg-customization-icon.png" class="pg-ext-icon" alt=""></div>
                    </div> 
                </div>
            </div>
        </div>                                                       
