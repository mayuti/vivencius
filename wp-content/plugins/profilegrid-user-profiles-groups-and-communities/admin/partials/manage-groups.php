...
<div class="pmagic pg-box-wrap pg-group-manager">
    ...
    <div class="pg-box-row">
<div class="pg-box-col-12 pg-box-col-md-12"> 
  ...
  <div class="pmagic-cards pg-box-row">
	...
	?>
   <div class="pg-box-col pg-box-col-md pg-card-mb-16">
...
<div class="pg-box-col pg-box-col-md-3">
    <div class="pg-group-side-banner pg-card-mb-16 pg-box-border pg-box-white-bg">
...
<!--                        <div class="pg-side-banner-button">
                        ...
                        <p class="pg-customize-banner-content">Have us build the exact feature that you need.  <a target="_blank" href="https://metagauss.com/customization-help/" class=""> <?php esc_html_e('Contact here', 'profilegrid-user-profiles-groups-and-communities'); ?> </a>	</p>
                         <div class="pg-side-banner-text"></div>
