...
{
        echo '<div class="pmagic"><div class="pg-no-group-found-warning"><div class="pmrow pg-alert-info pg-alert-warning">'. esc_html__( 'Sorry, this group is currently not accessible. Either it was deleted or its ID does not matches.','profilegrid-user-profiles-groups-and-communities' ).'</div></div></div>'; 
}
endif;
?>
