...
<body> <!-- Apertura de etiqueta del cuerpo de la web para despliege de contenido a visualizar -->
    <header>
        <h1>Política de Privacidad</h1> <!-- Se coloca título principal -->
    </header>
    <main>
        <?php
        // Utiliza include para cargar el contenido de document_privacidad.html
        include('document/document_privacidad.html');
    ?>
    </main>
    <footer>
